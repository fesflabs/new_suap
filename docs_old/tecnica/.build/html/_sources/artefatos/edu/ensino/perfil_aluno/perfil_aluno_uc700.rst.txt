...
.. _suap-artefatos-edu-ensino-perfil_aluno-uc700: 

UC 700 - Matrícula on-line - regíme seríado  <v0.1>
===================================================
...
Está funcionalidade permitirá que um discente realize uma matrícula on-line em componentes curriculares de 
cursos do regime seriado.
O pedido de matrícula on-line não inclue o aluno nos respectivos diários dos componentes, fato esse que 
só ocorrerá após o processamento da matrícula.

A matrícula on-line só estará acessível durante o período de vigência definido na "Configuração Período de Matrícula" do curso.
...
- O aluno deve possuir o status ``Em Aberto`` no período letivo a ser matriculado
- Deve existir uma configuração de período de matrícula para o curso do aluno
- Deve existir uma turma com diários definidos os locais e horários de aulas

Pós-condições
-------------

- Aluno com pedido de matrícula registrado e apto para processamento de matrícula.

Casos de Uso Impactados
-----------------------

	#. :ref:`suap-artefatos-edu-ensino-visao` - Altere esta referência
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``**menu**`` > ``**UCS**``
    #. O sistema exibe a lista de **ucs** (RIN1_)
    #. O **ator** seleciona a opção ``Adicionar **UC**`` 
...
"""""""""""""""""""""
	...
	#. O **ator** aciona a opção ``Editar`` de uma das **ucs** disponíveis na listagem
...
""""""""""""""""""""""""
	...
	#. O **ator** aciona a opção ``Ver`` do **uc** que se deseja exibir mais informações dentre um dos alunos
...
Os dados da **uc** é exibida dentro de uma caixa de nome "**nome_caixa_identificacao**", são eles:
