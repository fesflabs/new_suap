...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='SequencialMatriculaResidente',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', djtools.thumbs.ImageWithThumbsField(blank=True, null=True, storage=djtools.storages.storage.FileSystemStoragePlus(), upload_to='residentes')),
                ...
                ('ano_conclusao_estudo_anterior', djtools.db.models.ForeignKeyPlus(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residente_ano_conclusao_anterior_set', to='comum.ano', verbose_name='Ano de Conclusão de Estudo Anterior')),
                ...
                ('cidade_profissional', djtools.db.models.ForeignKeyPlus(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residente_cidade_profissional_set', to='comum.municipio', verbose_name='Cidade Profissional')),
                ('estado_emissao_carteira_reservista', djtools.db.models.ForeignKeyPlus(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residente_estado_emissor_carteira_reservista_set', to='comum.unidadefederativa', verbose_name='Estado Emissor')),
                ('naturalidade', djtools.db.models.ForeignKeyPlus(blank=True, help_text='Cidade em que o(a) residente nasceu. Obrigatório para brasileiros', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residente_naturalidade_set', to='comum.municipio', verbose_name='Naturalidade')),
                ...
                ('pessoa_fisica', djtools.db.models.ForeignKeyPlus(on_delete=django.db.models.deletion.CASCADE, related_name='residente_set', to='rh.pessoafisica', verbose_name='Pessoa Física')),
                ('uf_emissao_rg', djtools.db.models.ForeignKeyPlus(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residente_emissor_rg_set', to='comum.unidadefederativa', verbose_name='Estado Emissor')),
                ('uf_emissao_titulo_eleitor', djtools.db.models.ForeignKeyPlus(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residente_emissor_titulo_eleitor_set', to='comum.unidadefederativa', verbose_name='Estado Emissor')),
            ],
            options={
                'verbose_name': 'Residente',
                'verbose_name_plural': 'Residntes',
                'ordering': ('pessoa_fisica__nome',),
                'permissions': (('emitir_diploma', 'Pode emitir diploma de Residente'), ('emitir_boletim', 'Pode emitir boletim de Residente'), ('emitir_historico', 'Pode emitir histórico de Residente'), ('efetuar_matricula', 'Pode efetuar matricula de Residente'), ('pode_sincronizar_dados', 'Pode sincronizar dados de Residente'), ('gerar_relatorio', 'Pode gerar relatórios de Residente'), ('pode_ver_chave_acesso_pais', 'Pode ver chave de acesso dos pais'), ('change_foto', 'Pode editar foto de Residente'), ('view_dados_academicos', 'Pode visualizar dados acadêmicos de Residente'), ('view_dados_pessoais', 'Pode visualizar dados pessoais de Residente')),
            },
        ),
        migrations.CreateModel(
            name='Observacao',
            fields=[
                ...
                ('residente', djtools.db.models.ForeignKeyPlus(on_delete=django.db.models.deletion.CASCADE, to='residencia.residente', verbose_name='Residente')),
                ('usuario', djtools.db.models.ForeignKeyPlus(on_delete=django.db.models.deletion.CASCADE, related_name='residente_observacao_set', to=settings.AUTH_USER_MODEL, verbose_name='Usuário')),
            ],
            options={
