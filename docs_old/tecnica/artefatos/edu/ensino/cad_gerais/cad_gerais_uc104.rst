...
.. _suap-artefatos-edu-ensino-cad_gerais-uc104:

UC 104 - Manter Tipos de Componente <v0.1>
==========================================
...
Cadastrar, alterar, remove ou listar tipos de componentes.
...
Administrador: permite gerir o cadastro de tipos de componentes. 
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``Cadastros Gerais`` > ``Tipos de Componente``
    #. O sistema exibe a lista de tipos de componentes (RIN1_)
...
"""""""""""""""""""""
	...
	#. O administrador aciona a opção ``Editar`` dentre um dos tipos de componentes disponíveis na listagem
	#. O sistema exibe a turno com os dados (RIN2_) preenchidos
