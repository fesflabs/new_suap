...
.. _suap-artefatos-edu-ensino-proc_apoio-uc504: 

UC 504 - Manter e Configurar Períodos de Matrícula <v0.1>
=============================================
...
Este caso de uso descreve a pesquisa, edição e criação de um período de matrícula.
...
Administradores, Secretários e Diretores Acadêmicos.
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``Procedimentos de Apoio`` > ``Configurações de Períodos de Matrículas``
    #. O sistema exibe a lista de Configurações de Períodos de Matrículas (RIN1_)
...
"""""""""""""""""""""
    ...
    #. O usuário aciona a opção ``Editar`` de uma das configurações de período de matrícula disponíveis na listagem
    #. O sistema exibe uma visão da configuração de período de matrícula disponível (RIN2_) preenchidos
    #. O usuário informa novos valores para os dados (RIN2_) 
    #. O usário finaliza o caso de uso selecionando a opção ``Salvar``
...
"""""""""""""""""""""""""""""""""""""""""
    ...
    #. O usário aciona a opção ``Salvar e adicionar outro(a)``
...
""""""""""""""""""""""""""""""""""""""""""
    ...
    #. O usuário aciona a opção ``Salvar e continuar editando``
...
""""""""""""""""""""
    ...
    #. O usuário restringe a lista usando o filtro e/ou busca (RIN1_)
...
""""""""""""""""""""""""
    ...
    #. O usuário aciona a opção ``Ver`` da configuração de período de matrícula que se deseja realizar o vínculo dentre uma das 
       calendários acadêmicos disponíveis na listagem
    #. O sistema exibe informações da configuração de período de matrícula (RI1_)
