...
/**
 * IFMA/Tássio
 * inlines.js do Django alterado para não aparecer botão do inline formset para Adicionar outro item
 */
(function($) {
    'use strict';
    $.fn.formset = function(opts) {
        ...
        if ($this.length && showAddButton) {
            var addButton;
            // IFMA: Comentado para não aparecer botão do inline formset para Adicionar outro item
