...
.. _suap-artefatos-edu-ensino-cad_gerais-uc118:

UC 118 - Vincular Coordenador de Curso <v0.1>
=============================================
...
Caso de uso extensor que possibilitar associar um coordenador de cursos e seus respectivos cursos a uma Diretoria.
...
Administrador: associa coordenador de curso e seus respectivos cursos  a uma diretoria.
...
Deve existir ao menos um servidor e um curso cadastrados ativos.

Pós-condições
-------------

Nome do coordenador de curso será impresso no diploma ou certificado de curso dependendo do modelo de documento adotado.
...
.. _FN:
    ...
    #. O administrador seleciona a opção ``Adicionar Coordenadores de Curso`` 
...
.. list-table:: 
   ...
   * - Setor*
     ...
     - 
   * - Cursos*
     - Usuário (texto auto-completar multiplo)
     - 
     - 
     - 
     -      
