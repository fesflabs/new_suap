...
.. _suap-artefatos-edu-ensino-cad_gerais-uc105:

UC 105 - Niveis de Ensino <v0.1>
================================
...
Cadastrar, alterar, remove ou listar niveis de ensino.
...
Administrador: permite gerir o cadastro de niveis de ensino. 
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``Cadastros Gerais`` > ``Níveis de Ensino``
    #. O sistema exibe a lista de niveis de ensino (RIN1_)
...
"""""""""""""""""""""
	...
	#. O administrador aciona a opção ``Editar`` dentre um dos niveis de ensino disponíveis na listagem
