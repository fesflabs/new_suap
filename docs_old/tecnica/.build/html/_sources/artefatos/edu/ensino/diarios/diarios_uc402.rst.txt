...
.. _suap-artefatos-edu-ensino-diarios-uc402: 

UC 402 - Gerir Diários <v0.1>
=============================
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``Turmas e Diários`` > ``Diários``
    #. O sistema exibe a lista de Diários (RIN1_)
    #. O secretário seleciona a opção ``Adicionar Diário`` 
...
"""""""""""""""""""""
	...
	#. O secretário aciona a opção ``Editar`` de uma das Diários disponíveis na listagem
	#. O sistema exibe o Diário com os dados (RIN2_) preenchidos
...
""""""""""""""""""""""""
	...
	#. O secretário aciona a opção ``Ver`` da Diário que se deseja realizar o vínculo dentre uma das 
	   Diários disponíveis na listagem
	#. O sistema exibe informações da Diário (RI1_)
...
RI1 – Exibição da Diário 
"""""""""""""""""""""""""

Os dados da Diário é exibida dentro de uma caixa de nome "**nome_caixa_identificacao**", são eles:
...
.. list-table:: 
   ...
   * - RN1
     - | Exclusão fere integridade relacional.
       | mensagem: A remoção de Diário "<campo descrição>" pode resultar na remoção de objetos relacionados, mas sua conta não tem a permissão para remoção dos seguintes tipos de objetos: 
...
.. list-table:: 
   ...
   * - M3
     - Diário <campo nome1> alterado com sucesso. Você pode adicionar um outro Diretoria Acadêmica abaixo.
   * - M4
     - Diário <campo nome1> modificado com sucesso. Você pode editá-lo novamente abaixo.
   * - M5
     - Você tem certeza que quer remover Diário "<campo nome1>"? Todos os seguintes itens relacionados serão removidos:    
   * - M6
...
.. comentário para usar o exemplo abaixo, basta recuar a margem.
	...
	.. figure:: media/tela_uc**numero**.png
	   ...
	   Figura 2: Protótipo de tela para cadastro de Diários.	   
