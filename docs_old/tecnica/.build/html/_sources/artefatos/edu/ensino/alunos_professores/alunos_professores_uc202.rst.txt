...
.. _suap-artefatos-edu-ensino-alunos_professores-uc202: 

UC 202 - Gerir Aluno <v0.1>
===========================
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``Alunos e Professores`` > ``Alunos``
    #. O sistema exibe a lista de alunos (RIN1_)
...
"""""""""""""""""""""
	...
	#. O **ator** aciona a opção ``Editar`` de uma das alunos disponíveis na listagem
	#. O sistema exibe a listagem dos alunos com os dados (RIN2_) preenchidos
...
""""""""""""""""""""""""
	...
	#. O **ator** aciona a opção ``Ver`` do **uc** que se deseja exibir mais informações dentre um dos alunos disponíveis na listagem
	#. O sistema exibe informações do **uc** (RI1_)
...
.. _suap-artefatos-edu-ensino-alunos_professores-uc202-RI1:

RI1 – Exibição do aluno 
"""""""""""""""""""""""""""""""""""""

Os dados da listagem dos alunos é exibida dentro de uma caixa de nome "**nome_caixa_identificacao**", são eles:
...
.. _suap-artefatos-edu-ensino-alunos_professores-uc202-RIN1:
...
.. _suap-artefatos-edu-ensino-alunos_professores-uc202-RIN2:
...
.. comentário para usar o exemplo abaixo, basta recuar a margem.
	...
	.. figure:: media/tela_uc39_exibir.png
	   :align: center
	   :scale: 100 %
	   :alt: protótipo de tela.
	   :figclass: align-center
	   
	   Figura 1: Protótipo de tela para exibição de alunos.
...
.. comentário para usar o exemplo abaixo, basta recuar a margem.
	...
	.. figure:: media/tela_uc39.png
	   :align: center
	   :scale: 70 %
	   :alt: protótipo de tela.
	   :figclass: align-center
	   
	   Figura 2: Protótipo de tela para cadastro de alunos.	   
