...
$(document).ready(function() {
    ...
    var nivel_acesso_alterar_id_onready = $("#id_nivel_acesso_alterar").val();
    var hipotese_legal_id_onready = $("#id_hipotese_legal").val();

    log_info("nivel_acesso_id_onready: {0} ...".f(nivel_acesso_alterar_id_onready));
            ...
            $.get("/processo_eletronico/get_hipoteses_legais_by_processo_nivel_acesso/" + nivel_acesso_id_selected + "/", function (data) {
                ...
                $.each(data.hipoteses_legais, function(i, value) {
                    ...
                    if (hipotese_legal_id_onready && hipotese_legal_id_onready == value.id) {
                        log_info("Hipótese legal setada: o que está atualmente cadastrada no processo - '{0}' (id: {1}) ...".f(value.nome, value.id), 2);
    ...
    $("#id_nivel_acesso_alterar").trigger('change');
});
