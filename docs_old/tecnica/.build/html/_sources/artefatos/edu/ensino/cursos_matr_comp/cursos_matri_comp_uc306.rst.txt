...
.. _suap-artefatos-edu-ensino-cursos_matr_comp-uc306:

UC 306 - Gerir Matrizes Curriculares <v0.1>
===========================================
...
.. _FN:
    ...
    #. O **ator** seleciona a opção ``Adicionar Matriz Curricular`` 
...
"""""""""""""""""""""
	...
	#. O **ator** aciona a opção ``Editar`` de uma das matrizes curriculares disponíveis na listagem
...
""""""""""""""""""""""""
	...
	#. O **ator** aciona a opção ``Ver`` da matriz curricular que se deseja realizar o vínculo dentre uma das 
	   matrizes curriculares disponíveis na listagem
...
RI1 – Exibição da matriz curricular 
"""""""""""""""""""""""""""""""""""""

Os dados da matriz curricular é exibida dentro de uma caixa de nome "**nome_caixa_identificacao**", são eles:
...
RIN1 – Campos para listagem de matrizes curriculares
""""""""""""""""""""""""""""""""""""""""""""""""""
...
.. list-table:: 
   ...
   * - RN1
     - | Exclusão fere integridade relacional.
       | A remoção de Matriz Curricular "<campo descrição>" pode resultar na remoção de objetos relacionados, mas sua conta não tem a permissão para remoção dos seguintes tipos de objetos: 
...
.. list-table:: 
   ...
   * - M3
     - Matriz Curricular <campo nome1> alterado com sucesso. Você pode adicionar um outro Diretoria Acadêmica abaixo.
   * - M4
     - Matriz Curricular <campo nome1> modificado com sucesso. Você pode editá-lo novamente abaixo.
   * - M5
     - Você tem certeza que quer remover Matriz Curricular "<campo nome1>"? Todos os seguintes itens relacionados serão removidos:    
   * - M6
...
.. comentário para usar o exemplo abaixo, basta recuar a margem.
	...
	.. figure:: images/tela_uc**numero**_exibir.png
	   ...
	   Figura 1: Protótipo de tela para exibição de matrizes curriculares.
...
.. comentário para usar o exemplo abaixo, basta recuar a margem.
	...
	.. figure:: images/tela_uc**numero**.png
	   ...
	   Figura 2: Protótipo de tela para cadastro de matrizes curriculares.	   
