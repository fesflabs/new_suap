...
.. _suap-artefatos-edu-ensino-cad_gerais-uc119:

UC 119 - Vincular Secretário <v0.1>
===================================
...
Caso de uso extensor que possibilitar vincular secretários a uma Diretoria.
...
Administrador: associa um secretário a uma diretoria.
...
- Possibilita ao secretário ver informações do curso, turmas, diários e registros de emissão de diplomas de alunos que estejam 
  relacionados a diretória a qual ele está associado;
- Possibilita ao secretário visualizar calendários acadêmiocos do câmpus associado a diretoria na qual ele está associado;
- Possibilita ao secretário avaliar solicitações de usuários, tais como solicitação de relançamenteo de etapa pedido por um professor.
...
.. _FN:
    ...
    #. O administrador seleciona a opção ``Adicionar Secretários`` 
