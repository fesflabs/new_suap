        ...
        function (t, e, n) {
            var r = n(12),
                ...
                at = function (t, e, n) {
                    t === q && at(Y, e, n), f(t);
                    var r = v(e, !0);
                    return f(n), h(Q, r) ? (n.enumerable ? (h(t, D) && t[D][r] && (t[D][r] = !1), (n = g(n, { enumerable: b(0, !1) }))) : (h(t, D) || J(t, D, b(1, {})), (t[D][r] = !0)), rt(t, r, n)) : J(t, r, n);
                },
                st = function (t, e) {
                    f(t);
                    var n = m(e),
                            ...
                            "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                                ? function (t, n) {
                                      ...
                                      for (
                                          ...
                                          (s = h.call(y, r)) && !((l = y.lastIndex) > f && (u.push(r.slice(f, s.index)), s.length > 1 && s.index < r.length && d.apply(u, s.slice(1)), (c = s[0].length), (f = l), u.length >= o));
            ...
            (h || d || p) &&
                (u = function (t) {
                    ...
                    return (
                        ...
                        h && (e = a.lastIndex),
                        (r = l.call(s ? n : a, m)),
                        s ? (r ? ((r.input = r.input.slice(y)), (r[0] = r[0].slice(y)), (r.index = a.lastIndex), (a.lastIndex += r[0].length)) : (a.lastIndex = 0)) : h && r && (a.lastIndex = a.global ? r.index + r[0].length : e),
                        d &&
                            r &&
                            r.length > 1 &&
            ...
            if (o("Number", !v(" 0o1") || !v("0b1") || v("+0x1"))) {
                for (
                    var w,
                        ...
                        x = r ? d(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger,fromString,range".split(","),
                        j = 0;
                    x.length > j;
                    j++
                )
        ...
        function (t, e, n) {
            ...
            var r = [
                ...
                i = [
                    ...
                    function (t) {
                        if ("boolean" === t.type)
                            return "checkbox" === t.format || (t.options && t.options.checkbox) ? "checkbox" : "select2" === t.format ? "select2" : "selectize" === t.format ? "selectize" : "choices" === t.format ? "choices" : "select";
                    },
                    function (t) {
                    ...
                    !(function (t, e) {
                        ...
                        (this._validateStringSubSchema = {
                            ...
                            pattern: function (t, e, n) {
                                return new RegExp(t.pattern).test(e) ? [] : [{ path: n, property: "pattern", message: t.options && t.options.patternmessage ? t.options.patternmessage : this.translate("error_pattern", [t.pattern]) }];
                            },
                        }),
                                        ...
                                        t.required.forEach(function (o) {
                                            if (void 0 === e[o]) {
                                                ...
                                                (a && !1 === a.dependenciesFulfilled) ||
                                                    ...
                                                    i.push({ path: n, property: "required", message: r.translate("error_required", [t && t.properties && t.properties[o] && t.properties[o].title ? t.properties[o].title : o]) });
                                            }
                                        }),
                                    i
                                );
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function (t, e, n) {
                                ...
                                return (
                                    window.math ? (i = window.math.mod(window.math.bignumber(e), window.math.bignumber(r)).equals(0)) : window.Decimal && (i = new window.Decimal(e).mod(new window.Decimal(r)).equals(0)),
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                return (
                                    ...
                                    t.id && "string" == typeof t.id && "urn:" === t.id.substr(0, 4) ? (this.refs[t.id] = t) : t.$id && "string" == typeof t.$id && "urn:" === t.$id.substr(0, 4) && (this.refs[t.$id] = t),
                                    r
                                );
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                var n = t;
                                return (
                                    "http://" !== t.substr(0, 7) && "https://" !== t.substr(0, 8) && "blob:" !== t.substr(0, 5) && "data:" !== t.substr(0, 5) && "#" !== t.substr(0, 1) && "/" !== t.substr(0, 1) && (n = e + t),
                                    ...
                                    if (!i.refs[n])
                                        if (i._isUniformResourceName(n)) {
                                            ...
                                            var o,
                                                ...
                                                c = n;
                                            if ("function" != typeof l) throw (console.log('No "urn_resolver" callback defined to resolve "'.concat(c, '"')), new Error("Must set urn_resolver option to a callback to resolve ".concat(c)));
            ...
            var H = (function () {
                function t(e, n) {
                    !(function (t, e) {
                        ...
                        (this.key = void 0 !== this.parent ? this.path.split(".").slice(this.parent.path.split(".").length).join(".") : this.path),
                        (this.link_watchers = []),
                        (this.watchLoop = !1),
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function (t, e, n) {
                                if (
                                    (!this.template || n) &&
                                    (this.shouldBeUnset() || null != t ? ("object" === z(t) ? (t = JSON.stringify(t)) : this.shouldBeUnset() || "string" == typeof t || (t = "".concat(t))) : (t = ""), t !== this.serialized)
                                ) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                void 0 !== this.schema.maxLength && this.input.setAttribute("maxlength", this.schema.maxLength),
                                    void 0 !== this.schema.pattern ? this.input.setAttribute("pattern", this.schema.pattern) : void 0 !== this.schema.minLength && this.input.setAttribute("pattern", ".{".concat(this.schema.minLength, ",}")),
                            ...
                            value: function () {
                                ...
                                if (window.ace) {
                                    ...
                                    ("cpp" !== n && "c++" !== n && "c" !== n) || (n = "c_cpp"),
                                        (t = this.expandCallbacks("ace", f({}, { selectionStyle: "text", minLines: 30, maxLines: 30 }, this.defaults.options.ace || {}, this.options.ace || {}, { mode: "ace/mode/".concat(n) }))),
                            ...
                            value: function (t) {
                                ...
                                return (
                                    void 0 !== this.item_info[n] ||
                                        ...
                                        (this.item_info[n] = { title: this.translateProperty(e.title) || this.translate("default_array_item_title"), default: e.default, width: 12, child_editors: e.properties || e.items })),
                                    this.item_info[n]
                                );
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.collapsed = !1),
                                    ...
                                    this.tabs &&
                                        (this.add_row_button.classList.add("je-array-control-btn"), this.delete_last_row_button.classList.add("je-array-control-btn"), this.remove_all_rows_button.classList.add("je-array-control-btn"));
                            },
                        },
                        {
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                for (t = 0; t < n.length; t++) this.sanitize(n[t]) === n[t] && (this.option_keys.push("".concat(n[t])), this.option_titles.push("".concat(r[t] || n[t])), (this.select_values["".concat(n[t])] = n[t]));
                            },
                        },
                        {
                            key: "build",
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "enable",
                            value: function () {
                                !this.always_disabled && this.select2_instance && (this.select2v4 ? this.select2_instance.prop("disabled", !1) : this.select2_instance.select2("enable", !0)), Bt(Dt(o.prototype), "enable", this).call(this);
                            },
                        },
                        {
                            key: "disable",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                window.jQuery &&
                                    ...
                                    !this.selectize_instance &&
                                    ((t = this.expandCallbacks("selectize", f({}, { plugins: ["remove_button"], delimiter: !1, createOnBlur: !0, create: !0 }, this.defaults.options.selectize || {}, this.options.selectize || {}))),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                if (this.last_preview !== this.value && ((this.last_preview = this.value), (this.preview.innerHTML = ""), this.value)) {
                                    ...
                                    if ((t && (t = t[1]), t)) {
                                        if (
                                            ((this.preview.innerHTML = "<strong>Type:</strong> ".concat(t, ", <strong>Size:</strong> ").concat(Math.floor((this.value.length - this.value.split(",")[0].length - 1) / 1.33333), " bytes")),
                                            "image" === t.substr(0, 5))
                                        ) {
            ...
            var we = (function (t) {
                ...
                function o(t, e) {
                    ...
                    return (
                        ...
                        n.parent && n.parent.schema && (Array.isArray(n.parent.schema.required) ? n.parent.schema.required.includes(n.key) || n.parent.schema.required.push(n.key) : (n.parent.schema.required = [n.key])),
                        n
                    );
                }
                return (
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = this;
                                this.parent.options.table_row || ((this.label = this.header = this.theme.getCheckboxLabel(this.getTitle(), this.isRequired())),
                                    ...
                                    (this.control = this.theme.getFormControl(this.header, this.input, this.description, this.infoButton)),
                    ...
                    (n = [
                        {
                            key: "register",
                            value: function () {
                                Sn(Tn(o.prototype), "register", this).call(this), this.input && this.input.setAttribute("name", this.formname);
                            },
                        },
                        {
                            key: "unregister",
                            value: function () {
                                Sn(Tn(o.prototype), "unregister", this).call(this), this.input && this.input.removeAttribute("name");
                            },
                        },
                        {
                            key: "setValue",
                        ...
                        },
                        {
                            key: "enable",
                            value: function () {
                                Sn(Tn(o.prototype), "enable", this).call(this);
                            },
                        },
                        {
                            key: "disable",
                            value: function () {
                                Sn(Tn(o.prototype), "disable", this).call(this);
                            },
                        },
                        {
                            key: "refreshValue",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.template = null),
                                    ...
                                    this.label && this.label.parentNode && this.label.parentNode.removeChild(this.label),
                                    this.description && this.description.parentNode && this.description.parentNode.removeChild(this.description),
                                    Sn(Tn(o.prototype), "destroy", this).call(this);
                            },
                        },
                        {
                            key: "sanitize",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t;
                                this.template && ((t = this.getWatchedFieldValues()), this.setValue(this.template(t), !1, !0)), Sn(Tn(o.prototype), "onWatchedFieldChange", this).call(this);
                            },
                        },
                        {
                            key: "build",
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "build",
                            value: function () {
                                (this.options.format = "textarea"), vr(wr(o.prototype), "build", this).call(this), (this.input_type = this.schema.format), this.input.setAttribute("data-schemaformat", this.input_type);
                            },
                        },
                        {
                            key: "afterInputReady",
                                ...
                                this.jsoneditor.options.custom_validators && (n.custom_validators = this.jsoneditor.options.custom_validators),
                                    ...
                                    this.types.forEach(function (e, r) {
                                        ...
                                        (t.editors[r] = !1),
                                            "string" == typeof e
                                                ? ((i = f({}, t.schema)).type = e)
                                                : ((i = f({}, t.schema, e)), e.required && Array.isArray(e.required) && t.schema.required && Array.isArray(t.schema.required) && (i.required = t.schema.required.concat(e.required))),
                                ...
                                if (this.row_container) {
                                    ...
                                    if ("grid-strict" === this.format) {
                                        ...
                                        this.property_order.forEach(function (t) {
                                            var e = n.editors[t];
                                            e.property_removed ||
                                                ((i = n.theme.getGridRow()), r.appendChild(i), e.options.hidden ? (e.container.style.display = "none") : n.theme.setGridColumnSize(e.container, 12), i.appendChild(e.container));
                                        });
                                    }
                            ...
                            value: function () {
                                ...
                                if (
                                    ...
                                    Object.entries(this.schema.properties).forEach(function (e) {
                                        ...
                                        (t.editors[r] = t.jsoneditor.createEditor(o, { jsoneditor: t.jsoneditor, schema: i, path: "".concat(t.path, ".").concat(r), parent: t, compact: !0, required: !0 }, t.currentDepth + 1)),
                                ...
                                this.rows.forEach(function (i) {
                                    i.tab &&
                                        ...
                                        ((n && i.tab === e.rows[e.basicTab].tab && r) ||
                                            (t ? (i.tab_text.textContent = i.getHeaderText()) : (n && i.tab === e.rows[e.basicTab].tab && (r = !0), i.tab === e.active_tab ? e.theme.markTabActive(i) : e.theme.markTabInactive(i))));
                                });
                            },
                        },
                        {
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "build",
                            value: function () {
                                (this.options.format = "textarea"), hi(yi(o.prototype), "build", this).call(this), (this.input_type = this.schema.format), this.input.setAttribute("data-schemaformat", this.input_type);
                            },
                        },
                        {
                            key: "afterInputReady",
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "enable",
                            value: function () {
                                this.always_disabled || (this.select2_instance && (this.select2v4 ? this.select2_instance.prop("disabled", !1) : this.select2_instance.select2("enable", !0))), _i(ji(o.prototype), "enable", this).call(this);
                            },
                        },
                        {
                            key: "disable",
                            value: function (t) {
                                this.select2_instance && (this.select2v4 ? this.select2_instance.prop("disabled", !0) : this.select2_instance.select2("enable", !1)), _i(ji(o.prototype), "disable", this).call(this, t);
                            },
                        },
                        {
                            key: "destroy",
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                if ("function" == typeof SignaturePad) {
                                    ...
                                    return (
                                        (this.value = e), (this.input.value = this.value), this.signaturePad.clear(), t && "" !== t && this.signaturePad.fromDataURL(t), this.watch_listener(), this.jsoneditor.notifyWatchers(this.path), !1
                                    );
                                }
                            },
                        },
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "build",
                            value: function () {
                                (this.options.format = "textarea"), $i(Qi(o.prototype), "build", this).call(this), (this.input_type = this.schema.format), this.input.setAttribute("data-schemaformat", this.input_type);
                            },
                        },
                        {
                            key: "afterInputReady",
                            ...
                            value: function (t, e) {
                                ...
                                return (
                                    ...
                                    e ||
                                        (a.build(),
                                        a.postBuild(),
                                        (a.controls_cell = i.appendChild(this.theme.getTableCell())),
                                        (a.row = i),
                                    ...
                                    this.title_controls &&
                                        ...
                                        this.toggle_button.addEventListener("click", function (e) {
                                            e.preventDefault(),
                                                ...
                                                t.collapsed ? ((t.collapsed = !1), t.setButtonText(e.currentTarget, "", "collapse", "button_collapse")) : ((t.collapsed = !0), t.setButtonText(e.currentTarget, "", "expand", "button_expand"));
                                        }),
                                        this.options.collapsed && y(this.toggle_button, "click"),
                                        this.schema.options && void 0 !== this.schema.options.disable_collapse
                                            ? this.schema.options.disable_collapse && (this.toggle_button.style.display = "none")
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                (!0 === this.options.enable_drag_drop && !0 === this.options.hide_input) ||
                                                    ...
                                                    this.fileUploadGroup || ((this.fileUploadGroup = document.createElement("div")), this.fileUploadGroup.appendChild(this.fileDisplay), this.fileUploadGroup.appendChild(this.browseButton))),
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        !0 === this.options.enable_drag_drop &&
                                            ...
                                            this.browseButton && this.browseButton.parentNode && (this.browseButton.removeEventListener("click", this.clickHandler), this.browseButton.parentNode.removeChild(this.browseButton)),
                                            this.fileDisplay && this.fileDisplay.parentNode && (this.fileDisplay.removeEventListener("dblclick", this.clickHandler), this.fileDisplay.parentNode.removeChild(this.fileDisplay)),
            ...
            var Za = ["matches", "webkitMatchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector"].find(function (t) {
                            ...
                            { key: "afterInputReady", value: function (t) {} },
                            {
                                ...
                                value: function (t, e, n, r, i) {
                                    ...
                                    return (
                                        ...
                                        ("radio" !== e.type) || !t ? (r && t && t.appendChild(r), o.appendChild(e)) : ((e.style.width = "auto"), t.insertBefore(e, t.firstChild), r && t.appendChild(r)),
                                        n && o.appendChild(n),
                                        o
                                    );
                                },
            ...
            var os = (function (t) {
                ...
                var e,
                    ...
                    i = ns(o);
                function o() {
                    return Xa(this, o), i.apply(this, arguments);
                }
                return (
                    (e = o),
                    (n = [
                        {
                            key: "getFormInputLabel",
                            value: function (t, e) {
                                var n = ts(is(o.prototype), "getFormInputLabel", this).call(this, t, e);
                        ...
                        },
                        {
                            key: "getFormInputDescription",
                            value: function (t) {
                                var e = ts(is(o.prototype), "getFormInputDescription", this).call(this, t);
                        ...
                        },
                        {
                            key: "getIndentedPanel",
                            value: function () {
                                var t = ts(is(o.prototype), "getIndentedPanel", this).call(this);
                                return t.classList.add("je-indented-panel"), t;
                            },
                        },
                        {
                        ...
                        },
                        {
                            key: "getChildEditorHolder",
                            value: function () {
                                var t = ts(is(o.prototype), "getChildEditorHolder", this).call(this);
                        ...
                        },
                        {
                            key: "getTable",
                            value: function () {
                                var t = ts(is(o.prototype), "getTable", this).call(this);
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                t.errmsg
                                    ...
                                    : ((t.errmsg = document.createElement("div")), t.errmsg.setAttribute("class", "errmsg"), (t.errmsg.style = t.errmsg.style || {}), (t.errmsg.style.color = "red"), n.appendChild(t.errmsg)),
                                    (t.errmsg.innerHTML = ""),
            ...
            var ms = (function (t) {
                ...
                var e,
                    ...
                    i = ds(o);
                function o() {
                    return cs(this, o), i.apply(this, arguments);
                }
                return (
                    (e = o),
                    (n = [
                        {
                            key: "getSelectInput",
                            value: function (t, e) {
                                var n = hs(ys(o.prototype), "getSelectInput", this).call(this, t);
                        ...
                        },
                        {
                            key: "getRangeInput",
                            value: function (t, e, n) {
                                return hs(ys(o.prototype), "getRangeInput", this).call(this, t, e, n);
                            },
                        },
                        {
                            key: "getFormInputField",
                            value: function (t) {
                                var e = hs(ys(o.prototype), "getFormInputField", this).call(this, t);
                        ...
                        },
                        {
                            key: "getButton",
                            value: function (t, e, n) {
                                var r = hs(ys(o.prototype), "getButton", this).call(this, t, e, n);
            ...
            var js = { disable_theme_rules: !1, input_size: "normal", custom_forms: !1, object_indent: !0, object_background: "bg-light", object_text: "", table_border: !1, table_zebrastyle: !1, tooltip: "bootstrap" },
                Os = (function (t) {
                    !(function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), e && _s(t, e);
                    })(o, t);
                    var e,
                        n,
                        r,
                        ...
                        (n = [
                            {
                                key: "getSelectInput",
                                value: function (t, e) {
                                    var n = gs(xs(o.prototype), "getSelectInput", this).call(this, t);
                                    return (
                            ...
                            },
                            {
                                key: "getRangeInput",
                                value: function (t, e, n) {
                                    var r = gs(xs(o.prototype), "getRangeInput", this).call(this, t, e, n);
                            ...
                            },
                            {
                                key: "getFormInputField",
                                value: function (t) {
                                    var e = gs(xs(o.prototype), "getFormInputField", this).call(this, t);
                                    return (
                                        "checkbox" !== t &&
                                            "radio" !== t &&
                                            "file" !== t &&
                                            (e.classList.add("form-control"), "small" === this.options.input_size && e.classList.add("form-control-sm"), "large" === this.options.input_size && e.classList.add("form-control-lg")),
                            ...
                            },
                            {
                                key: "getButton",
                                value: function (t, e, n) {
                                    var r = gs(xs(o.prototype), "getButton", this).call(this, t, e, n);
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var e = document.createElement("div"),
                                        n = void 0 === t ? "" : t;
                                    return (
                                        (e.innerHTML = "<div class='col-md-2' id='".concat(n, "'><ul class='nav flex-column nav-pills'></ul></div><div class='col-md-10'><div class='tab-content' id='").concat(n, "'></div></div>")),
                                        e.classList.add("row"),
                                        e
                                    );
                                },
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        ...
                                        (n.innerHTML = "<div class='card-header'><ul class='nav nav-tabs card-header-tabs' id='".concat(e, "'></ul></div><div class='card-body'><div class='tab-content' id='").concat(e, "'></div></div>")),
                                        n
                                    );
                                },
                            },
            ...
            function Ts(t, e) {
                return !e || ("object" !== Cs(e) && "function" != typeof e)
                    ? (function (t) {
                          if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                          return t;
                      })(t)
            ...
            var Is = (function (t) {
                !(function (t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), e && Rs(t, e);
                })(o, t);
                var e,
                    n,
                    r,
                    ...
                    (n = [
                        {
                            key: "getTable",
                            value: function () {
                                var t = Ps(As(o.prototype), "getTable", this).call(this);
                        ...
                        },
                        {
                            key: "getTableHeaderCell",
                            value: function (t) {
                                var e = Ps(As(o.prototype), "getTableHeaderCell", this).call(this, t);
                        ...
                        },
                        {
                            key: "getTableCell",
                            value: function () {
                                var t = Ps(As(o.prototype), "getTableCell", this).call(this);
                        ...
                        },
                        {
                            key: "getFormControl",
                            value: function (t, e, n, r) {
                                var i = Ps(As(o.prototype), "getFormControl", this).call(this, t, e, n, r);
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                t.controls
                                    ? (t.errmsg ? (t.errmsg.style.display = "") : ((t.errmsg = document.createElement("div")), t.errmsg.classList.add("ui-state-error"), t.controls.appendChild(t.errmsg)), (t.errmsg.textContent = e))
                                    : (this.queuedInputErrorText = e);
                            },
                        },
                        {
            ...
            function Hs(t, e) {
                return !e || ("object" !== Bs(e) && "function" != typeof e)
                    ? (function (t) {
                          if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                          return t;
                      })(t)
            ...
            var Ms = (function (t) {
                !(function (t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), e && Vs(t, e);
                })(o, t);
                var e,
                    n,
                    r,
                    i = Ds(o);
                function o() {
                    return Ns(this, o), i.apply(this, arguments);
                }
                return (
                    (e = o),
                    (n = [
            ...
            var Qs = { disable_theme_rules: !1, label_bold: !0, align_bottom: !1, object_indent: !1, object_border: !1, table_border: !1, table_zebrastyle: !1, input_size: "normal" },
                Ys = (function (t) {
                    !(function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    return (
                        ...
                        (n = [
                            ...
                            },
                            {
                                key: "getButtonHolder",
                                value: function () {
                                    var t = Gs(Zs(o.prototype), "getButtonHolder", this).call(this);
                                    return t.classList.add("btn-group"), t;
                                },
                            },
                            {
                                key: "getFormButtonHolder",
                                value: function (t) {
                                    var e = Gs(Zs(o.prototype), "getFormButtonHolder", this).call(this);
                            ...
                            },
                            {
                                key: "getFormButton",
                                value: function (t, e, n) {
                                    var r = Gs(Zs(o.prototype), "getFormButton", this).call(this, t, e, n);
                            ...
                            },
                            {
                                key: "getButton",
                                value: function (t, e, n) {
                                    var r = Gs(Zs(o.prototype), "getButton", this).call(this, t, e, n);
                            ...
                            },
                            {
                                key: "getFormInputDescription",
                                value: function (t) {
                                    var e = Gs(Zs(o.prototype), "getFormInputDescription", this).call(this, t);
                            ...
                            },
                            {
                                key: "getFormInputLabel",
                                value: function (t, e) {
                                    var n = Gs(Zs(o.prototype), "getFormInputLabel", this).call(this, t, e);
                            ...
                            },
                            {
                                key: "getCheckboxLabel",
                                value: function (t, e) {
                                    var n = Gs(Zs(o.prototype), "getCheckboxLabel", this).call(this, t, e),
                            ...
                            },
                            {
                                key: "getMultiCheckboxHolder",
                                value: function (t, e, n, r) {
                                    return Gs(Zs(o.prototype), "getMultiCheckboxHolder", this).call(this, t, e, n, r);
                                },
                            },
                            {
                                key: "getFormRadio",
                            ...
                            },
                            {
                                key: "getFormRadioLabel",
                                value: function (t, e) {
                                    var n = Gs(Zs(o.prototype), "getFormRadioLabel", this).call(this, t, e),
                                        r = document.createElement("i");
                            ...
                            },
                            {
                                key: "getFormInputField",
                                value: function (t) {
                                    var e = Gs(Zs(o.prototype), "getFormInputField", this).call(this, t);
                            ...
                            },
                            {
                                key: "getRangeControl",
                                value: function (t, e) {
                                    var n = Gs(Zs(o.prototype), "getRangeControl", this).call(this, t, e);
                            ...
                            },
                            {
                                key: "getSelectInput",
                                value: function (t, e) {
                                    var n = Gs(Zs(o.prototype), "getSelectInput", this).call(this, t);
                            ...
                            },
                            {
                                key: "getTable",
                                value: function () {
                                    var t = Gs(Zs(o.prototype), "getTable", this).call(this);
                            ...
                            },
                            {
                                key: "getProgressBar",
                                value: function () {
                                    var t = Gs(Zs(o.prototype), "getProgressBar", this).call(this);
            ...
            var ol = { disable_theme_rules: !1, label_bold: !1, object_panel_default: !0, object_indent: !0, object_border: !1, table_border: !1, table_hdiv: !1, table_zebrastyle: !1, input_size: "small", enable_compact: !1 },
                al = (function (t) {
                    !(function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    return (
                        ...
                        (n = [
                            ...
                            },
                            {
                                key: "getSelectInput",
                                value: function (t, e) {
                                    var n = tl(il(o.prototype), "getSelectInput", this).call(this, t);
                                    return (
                                        e
                            ...
                            },
                            {
                                key: "getTextareaInput",
                                value: function () {
                                    var t = tl(il(o.prototype), "getTextareaInput", this).call(this);
                                    return (
                            ...
                            },
                            {
                                key: "getRangeControl",
                                value: function (t, e) {
                                    var n = tl(il(o.prototype), "getRangeControl", this).call(this, t, e);
                            ...
                            },
                            {
                                key: "getCheckboxLabel",
                                value: function (t, e) {
                                    var n = tl(il(o.prototype), "getCheckboxLabel", this).call(this, t, e);
                            ...
                            },
                            {
                                key: "getMultiCheckboxHolder",
                                value: function (t, e, n, r) {
                                    var i = tl(il(o.prototype), "getMultiCheckboxHolder", this).call(this, t, e, n, r);
                            ...
                            },
                            {
                                key: "getFormRadioLabel",
                                value: function (t, e) {
                                    var n = tl(il(o.prototype), "getFormRadioLabel", this).call(this, t, e);
                            ...
                            },
                            {
                                key: "getRadioHolder",
                                value: function (t, e, n, r, i) {
                                    var a = tl(il(o.prototype), "getRadioHolder", this).call(this, e, n, r, i);
                            ...
                            },
                            {
                                key: "getFormInputLabel",
                                value: function (t, e) {
                                    var n = tl(il(o.prototype), "getFormInputLabel", this).call(this, t, e);
                            ...
                            },
                            {
                                key: "getFormInputField",
                                value: function (t) {
                                    var e = tl(il(o.prototype), "getFormInputField", this).call(this, t);
                                    return (
                                ...
                                value: function (t, e, n, r) {
                                    ...
                                    return (
                                        ...
                                        t &&
                                            ...
                                            "checkbox" === e.type && (e.classList.add("form-checkbox", "text-xs", "text-red-600", "mr-1"), t.classList.add("items-center", "flex"), (t = this.getFormCheckboxControl(t, e, !1, r))),
                            ...
                            },
                            {
                                key: "getButton",
                                value: function (t, e, n) {
                                    var r = tl(il(o.prototype), "getButton", this).call(this, t, e, n);
                            ...
                            },
                            {
                                key: "getTable",
                                value: function () {
                                    var t = tl(il(o.prototype), "getTable", this).call(this);
                            ...
                            },
                            {
                                key: "getTableRow",
                                value: function () {
                                    var t = tl(il(o.prototype), "getTableRow", this).call(this);
                            ...
                            },
                            {
                                key: "getTableHeaderCell",
                                value: function (t) {
                                    var e = tl(il(o.prototype), "getTableHeaderCell", this).call(this, t);
                            ...
                            },
                            {
                                key: "getTableCell",
                                value: function () {
                                    var t = tl(il(o.prototype), "getTableCell", this).call(this);
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    t.controlgroup &&
                                        ...
                                        t.errmsg ? (t.errmsg.style.display = "") : ((t.errmsg = document.createElement("p")), t.errmsg.classList.add("block", "mt-1", "text-xs", "text-red"), t.controlgroup.appendChild(t.errmsg)),
                                        (t.errmsg.textContent = e));
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    t.tab.firstChild.classList.add("block"),
                                        !0 === t.tab.firstChild.classList.contains("border-b") ? (t.tab.firstChild.classList.add("border-b-0"), t.tab.firstChild.classList.remove("border-b")) : t.tab.firstChild.classList.add("border-b-0"),
                            ...
                            },
                            {
                                key: "markTabInactive",
                                value: function (t) {
                                    !0 === t.tab.firstChild.classList.contains("border-b-0") ? (t.tab.firstChild.classList.add("border-b"), t.tab.firstChild.classList.remove("border-b-0")) : t.tab.firstChild.classList.add("border-b"),
            ...
            var sl = { html: os, bootstrap3: ms, bootstrap4: Os, jqueryui: Is, barebones: Ms, spectre: Ys, tailwind: al },
                ll = {
            ...
            var dl = (function () {
                function t(e) {
                    ...
                    if ((hl(this, t), !(e instanceof Element))) throw new Error("element should be an instance of Element");
                    (this.element = e),
                    ...
                    var a = f(ll, this.getEditorsRules()),
                        s = function (t, e, r) {
            ...
            (dl.defaults = c),
                (dl.AbstractEditor = H),
                (dl.AbstractTheme = Qa),
                (dl.AbstractIconLib = ra),
                Object.assign(dl.defaults.themes, sl),
                Object.assign(dl.defaults.editors, Qo),
                Object.assign(dl.defaults.templates, Yo),
                Object.assign(dl.defaults.iconlibs, $a);
        },
    ]);
});
