...
.. _suap-artefatos-edu-ensino-cad_gerais-uc122:

UC 122 - Manter Núcleo Central Estruturante <v0.1>
==================================================
...
Cadastrar, alterar, remove ou listar Núcleo Central Estruturante.
...
Administrador: permite gerir o cadastro de Núcleo Central Estruturante. 
...
.. _FN:
    ...
    #. O caso de uso é iniciado acionando a opção  ``ENSINO`` > ``Cadastros Gerais`` > `` NCE``
    #. O sistema exibe a lista de Núcleo Central Estruturante (RIN1_)
    #. O administrador seleciona a opção ``Adicionar NCE``
...
"""""""""""""""""""""
	...
	#. O administrador aciona a opção ``Editar`` dentre um dos Núcleo Central Estruturante disponíveis na listagem
	#. O sistema exibe a NCE com os dados (RIN2_) preenchidos
...
RIN1 – Campos para listagem de Núcleo Central Estruturante
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
.. list-table:: 
   ...
   * - RN1
     - | Exclusão fere integridade relacional.
       | mensagem: A remoção de NCE "<campo descrição>" pode resultar na remoção de objetos relacionados, mas sua conta não tem a permissão para remoção dos seguintes tipos de objetos: 
...
.. list-table:: 
   ...
   * - M5
     - Você tem certeza que quer remover NCE "<campo nce>"? Todos os seguintes itens relacionados serão removidos:    
   * - M6
