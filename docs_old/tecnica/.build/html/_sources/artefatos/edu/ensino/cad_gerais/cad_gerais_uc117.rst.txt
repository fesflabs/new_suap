...
.. _suap-artefatos-edu-ensino-cad_gerais-uc117:

UC 117 - Vincular Diretor Acadêmico <v0.1>
==========================================
...
Caso de uso extensor que possibilitar vincular um diretor acadêmico a uma Diretoria.
...
Administrador: associa um diretor acadêmico a uma diretoria.
...
Nome do diretor acadêmico títular será impresso no diploma ou certificado de curso dependendo do modelo de documento adotado.
...
.. _FN:
    ...
    #. O administrador seleciona a opção ``Adicionar Diretor Acadêmico`` 
