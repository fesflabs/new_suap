...
class Log(models.ModelPlus):
    ...
    user = models.ForeignKeyPlus('comum.User', null=True, on_delete=models.SET_NULL , related_name='logs_user_residente')
    residente = models.ForeignKeyPlus('residencia.Residente', null=True, on_delete=models.SET_NULL)
    ...
    ref_residente = models.IntegerField(null=True, db_index=True)
    ref_diario = models.IntegerField(null=True, db_index=True)
    ...
    def get_absolute_url(self):
        return "/residencia/log/{:d}/".format(self.pk)
    ...
    def set_up(self, user, tipo, instance, descricao):
        ...
        self.ref_diario = None
        if hasattr(instance, 'diario') and instance.diario:
            self.ref_diario = instance.diario.pk
        elif hasattr(instance, 'get_diario') and hasattr(instance.get_diario(), 'pk'):
            self.ref_diario = instance.get_diario().pk

        self.ref_residente = None
        if hasattr(instance, 'residente'):
            self.ref_residente = instance.residente.pk
        elif hasattr(instance, 'get_residente') and hasattr(instance.get_residente(), 'pk'):
            self.ref_residente = instance.get_residente().pk
...
class LogResidenciaModel(models.ModelPlus):
    class Meta:
        abstract = True
