...
.. _suap-artefatos-adm-projetos-uc100:

UC100 - Manter edital <v0.1>
============================
...
#. O ator seleciona a opção ``Visualizar`` de uma das linhas da listagem de editais já cadastrados
#. Na tela ``Visualizar edital`` o sistema:

   #) Apresenta os campos (RIN02)
   #) Apresenta a listagem "Anexos do edital" (PDE_ 01 - RNI01)
   #) Apresenta a listagem "Anexos dos projetos " (PDE_ 02 - RNI01)
   #) Apresenta a listagem "Fonte de recursos" (PDE_ 03 - RNI01)
   #) Apresenta a listagem "Plano de oferta" (PDE_ 04 - RNI01)
   #) Apresenta a listagem "Critérios de avaliação" (PDE_ 05 - RNI01)
...
RIN02 – Campos para cadastros de editais (incluir, editar e visualizar)
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
